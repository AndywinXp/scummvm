...
public:
	...
	virtual int startVoice(const char *fileName, ScummFile *file, unsigned int offset, unsigned int size) { return 0; }
	...
	virtual int  getCurSpeechVolume() const { return 0; }
	virtual int  getCurSpeechPan() const { return 0; }
	virtual int  getCurSpeechFrequency() const { return 0; }
