...
//
//	}
//	Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::getSoundAddrData(): soundId is 0 or out of range");
	return nullptr;
}
...
//			}
//		} else {
//			Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::seek(): soundId is 0 or out of range");
//		}
//	} else {
//		Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::seek(): can't find sound %d (%s); did you forget to open it?", soundId, fileName);
//	}
...
//							Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::read(): WARNING: tried to read %d bytes, got %d instead (soundId %d (%s))", size, resultingSize, soundId, fileName);
//
...
//		}
//
//		Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::read(): can't find sound %d (%s); did you forget to open it?", soundId, fileName);
//
//	} else {
//		Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::read(): soundId is 0 or out of range");
//	}
...
IMuseDigiSndBuffer *IMuseDigiFilesHandler::getBufInfo(int bufId) {
	...
	Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::getBufInfo(): ERROR: invalid buffer id");
	return nullptr;
}

uint8 *IMuseDigiFilesHandler::fetchMap(int soundId) {
	return nullptr;
}
...
//		if (!s) {
//			Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::openSound(): can't open sound %d (%s)", soundId, fileName);
//			return 1;
//		}
//	} else {
...
//		if (!s) {
//			Debug::debug(Debug::Sound, "IMuseDigiFilesHandler::openSound(): can't open sound %d", soundId);
//			return 1;
//		}
//	}
...
void IMuseDigiFilesHandler::closeAllSounds() {
	//ImuseSndMgr::SoundDesc *s = _sound->getSounds();
	//for (int i = 0; i < MAX_IMUSE_SOUNDS; i++) {
	//	if (s[i].inUse) {
...
void IMuseDigiFilesHandler::flushSounds() {
	...
	//ImuseSndMgr::SoundDesc *s = _sound->getSounds();
	//for (int i = 0; i < MAX_IMUSE_SOUNDS; i++) {
	//	ImuseSndMgr::SoundDesc *curSnd = &s[i];
